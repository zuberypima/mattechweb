...
// Reuse the same navigation and mega-menu logic from main.js
// Ideally this should be a shared module, but for now we duplicate the logic to ensure it works on this page too.
