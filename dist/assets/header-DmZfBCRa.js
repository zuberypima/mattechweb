(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const i of t.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function l(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function n(e){if(e.ep)return;e.ep=!0;const t=l(e);fetch(e.href,t)}})();function u(){const o=document.querySelector(".hamburger"),s=document.querySelector(".nav-links");o&&o.addEventListener("click",()=>{s.classList.toggle("open")});const l=document.querySelectorAll(".dropdown");l.forEach(e=>{const t=e.querySelector("a");t&&t.addEventListener("click",i=>{window.innerWidth<=960&&(i.preventDefault(),l.forEach(a=>{a!==e&&a.classList.remove("dropdown-active")}),e.classList.toggle("dropdown-active"))})});const n=document.querySelectorAll(".sector-container");n.length>0&&n.forEach(e=>{const t=e.querySelectorAll(".sector-tabs li"),i=e.querySelectorAll(".sector-content");t.forEach(a=>{const c=r=>{if(r.type==="click"&&window.innerWidth>960)return;r.type==="click"&&r.preventDefault(),t.forEach(d=>d.classList.remove("active")),a.classList.add("active"),i.forEach(d=>d.classList.remove("active"));const h=a.getAttribute("data-tab"),m=document.getElementById(h);m&&m.classList.add("active")};a.addEventListener("mouseover",c),a.addEventListener("click",c),a.addEventListener("touchstart",r=>{c(r)},{passive:!0})})})}const v=`
<footer id="contact">
    <div class="container">
...
`;async function p(){const o=document.getElementById("header-container");o&&(o.innerHTML=f,u())}function g(){const o=document.getElementById("footer-container");o&&(o.innerHTML=v)}export{g as a,v as f,f as h,u as i,p as l};
